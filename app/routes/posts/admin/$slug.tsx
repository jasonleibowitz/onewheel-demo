		...
		<Form method="post" key={data.post?.slug ?? 'new'}>
			...
			<p>
				<label>
					...
					<textarea id="markdown" name="markdown" rows={20} className={`${inputClassName} font-mono`} defaultValue={data.post?.markdown ?? ''} />
				</label>
			</p>
...
export function CatchBoundary() {
	...
	if (caught.status === 404) {
		return <div>Uh oh! This post with the slug "{params.slug}" does not exist!</div>
	}
